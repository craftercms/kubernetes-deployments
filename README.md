...
- `minikube image pull craftercms/authoring_tomcat:4.4.2`
- `minikube image pull craftercms/authoring_tomcat:4.4.2E`
- `minikube image pull craftercms/delivery_tomcat:4.4.2`
- `minikube image pull craftercms/delivery_tomcat:4.4.2E`
- `minikube image pull craftercms/deployer:4.4.2`
- `minikube image pull craftercms/deployer:4.4.2E`
