...
- `minikube image pull craftercms/authoring_tomcat:4.4.7`
- `minikube image pull craftercms/authoring_tomcat:4.4.7E`
- `minikube image pull craftercms/delivery_tomcat:4.4.7`
- `minikube image pull craftercms/delivery_tomcat:4.4.7E`
- `minikube image pull craftercms/deployer:4.4.7`
- `minikube image pull craftercms/deployer:4.4.7E`
