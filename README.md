...
- `minikube image pull craftercms/authoring_tomcat:4.3.2`
- `minikube image pull craftercms/authoring_tomcat:4.3.2E`
- `minikube image pull craftercms/delivery_tomcat:4.3.2`
- `minikube image pull craftercms/delivery_tomcat:4.3.2E`
- `minikube image pull craftercms/deployer:4.3.2`
- `minikube image pull craftercms/deployer:4.3.2E`
