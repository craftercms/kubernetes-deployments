...
- `minikube image pull craftercms/authoring_tomcat:5.0.0-SNAPSHOTE`
- `minikube image pull craftercms/delivery_tomcat:5.0.0-SNAPSHOT`
- `minikube image pull craftercms/delivery_tomcat:5.0.0-SNAPSHOTE`
- `minikube image pull craftercms/deployer:5.0.0-SNAPSHOT`
- `minikube image pull craftercms/deployer:5.0.0-SNAPSHOTE`
