...
- `minikube image pull craftercms/authoring_tomcat:4.4.1`
- `minikube image pull craftercms/authoring_tomcat:4.4.1E`
- `minikube image pull craftercms/delivery_tomcat:4.4.1`
- `minikube image pull craftercms/delivery_tomcat:4.4.1E`
- `minikube image pull craftercms/deployer:4.4.1`
- `minikube image pull craftercms/deployer:4.4.1E`
