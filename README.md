...
- `minikube image pull craftercms/authoring_tomcat:4.3.1`
- `minikube image pull craftercms/authoring_tomcat:4.3.1E`
- `minikube image pull craftercms/delivery_tomcat:4.3.1`
- `minikube image pull craftercms/delivery_tomcat:4.3.1E`
- `minikube image pull craftercms/deployer:4.3.1`
- `minikube image pull craftercms/deployer:4.3.1E`
