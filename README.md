...
- `minikube image pull craftercms/authoring_tomcat:4.4.3`
- `minikube image pull craftercms/authoring_tomcat:4.4.3E`
- `minikube image pull craftercms/delivery_tomcat:4.4.3`
- `minikube image pull craftercms/delivery_tomcat:4.4.3E`
- `minikube image pull craftercms/deployer:4.4.3`
- `minikube image pull craftercms/deployer:4.4.3E`
